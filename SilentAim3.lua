...
function hookmetamethod(object, metamethod, hook)
    ...
    -- Save the original metamethod
    local original = mt[metamethod]

    -- Set the new metamethod
    mt[metamethod] = function(...)
        return hook(original, ...)
    end

    -- Return the original metamethod in case you need to unhook later
    return original
end
...
local m
m = hookmetamethod(game, "__index", hookFunction)
